...
namespace CharacterAI_Discord_Bot.Service
{
    public partial class CommandsService : CommonService
    {
        ...
        public static bool ValidateBotRole(SocketCommandContext context)
        {
            ...
            //if (user!.Id == context.Guild.OwnerId || user!.Id == BotConfig.ManageCharacterId) return true;

            if (user!.Id == BotConfig.ManageCharacterId) return true; // delete if uncomment the lines above
            ...
            return false; // delete if uncomment the lines above
        }
    }
}
