...
namespace CharacterAI_Discord_Bot.Service
{
    public partial class HandlerService : CommonService
    {
        ...
        public static async Task<ulong> ReplyMessage(SocketUserMessage message, Reply reply, bool isPrivate)
        {
            string replyText = reply.Text!;
            ...
            var mentions = isPrivate ? AllowedMentions.None : AllowedMentions.All;
            var botReply = await message.Channel.SendMessageAsync(replyText, embed: embed, allowedMentions: mentions).ConfigureAwait(false);
